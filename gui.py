...
class Window(QtGui.QMainWindow):
    ...
    def home(self):
        ...
        self.natural_frequencies = [261.63, 293.66, 329.63, 349.23, 391.99, 440.0, 493.88]
...
@pyqtSlot(float)
def on_press(freq):
    global note #Variável para o objeto da nota a ser tocada, obs: precisa ser global pois será chamado em outra função
    note = Note(freq)
    note.play()
